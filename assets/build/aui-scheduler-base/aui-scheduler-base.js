...
var Lang = A.Lang,
	...
	TPL_SCHEDULER_NAV = '<div class="aui-btn-group"></div>',
...
A.SchedulerEvent = SchedulerEvent;var SchedulerCalendar = A.Base.create(SCHEDULER_CALENDAR, A.ModelList, [], {
...
A.SchedulerCalendar = SchedulerCalendar;A.SchedulerEvents = A.Base.create('scheduler-events', A.ModelList, [], {
...
A.Scheduler = SchedulerBase;var SchedulerView = A.Component.create({
	NAME: SCHEDULER_VIEW,
