<cfcomponent name="Grupo" persistent="true" table="tbl_Grupo" autoindex="true" indexable="true">
	...
	<!--- Métodos --->
	<cffunction name="grupoExiste" hint="Fun&ccedil;&atilde;o com retorno tipo Bool que retorna TRUE se h&aacute; um grupo existente com mesmo titulo" returntype="boolean">
